...
export const MomentImage = ({ imageUrl }: { imageUrl: string }) => {
  const effects =
    "cursor-pointer duration-800 shadow-md hover:shadow-xl hover:scale-150 transform-3d perspective-1000 origin-center-right hover:md:scale-200 hover:md:left-0 border-white/80 hover:border-white/90 border-4 md:border-10 outline-olive-500 outline-3 hover:outline-olive-600/90";
  return (
    <div
...
export const CardLayout = ({ title, lead, imageUrl, position }: Props) => {

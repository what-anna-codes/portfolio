...
export const MomentContent = ({
  ...
  return (
    <div className="relative w-auto h-12.5 md:h-25 grow">
      <h3 className="relative h-full pb-2 grow md:grow pl-8 md:pl-16 mr-4 md:mr-12 md:w-fit md:min-w-[65%] md:max-w-[75%] border-b-2 md:border-b-6 z-50 border-olive-500 flex items-end justify-end text-olive-600 text-right text-2xl md:text-3xl font-semibold  ">
        {title}
